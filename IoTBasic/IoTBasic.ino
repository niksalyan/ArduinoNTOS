 ...
 */
 ...
 void bsetup() {
  /* put your setup code here, to run once: */
    ...
    tft.fillRect(25, 25, 430, 270, TFT_WHITE);
    for (int hvr = 0; hvr < 578; hvr++) {
      tft.fillCircle(pgm_read_word(&greeting_hello[hvr * 2]) + 85, pgm_read_word(&greeting_hello[hvr * 2 + 1]) + 100, 4, TFT_BLACK);
      delay(1.5);
    }
    delay(2000);
